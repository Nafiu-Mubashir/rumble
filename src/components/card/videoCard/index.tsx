...
views?: string;
author?: string;
category?: 'playlist' | 'leaderboard'
}


const VideoCard = ({status, videoLink, category}: CardProps) => {
  ...
  return (
    <a href="/single-video/id">
      <div
        ...
        <div className="w-full cursor-pointer group space-y-2">
          <div
            className={`${
              status === "live"
                ? " border-2 border-[#EB2626] bg-[#EB2626]"
                : status === "upcoming"
              ...
              isOpen
                ? "lg:h-[10rem]"
                : "w-full h-[10.125reem] md:h-[13.816rem] lg:h-[12.063rem]"
            } rounded-lg relative`}>
                ...
                <div className="bg-rumble-dark/90 flex justify-between p-2 absolute w-full bottom-0 rounded-b-md">
                  ...
                  <a href="/">
                    <svg
                      ...
                      <path
                        stroke="white"
                        d="M15.8364 20.6212c-.7278.3644-1.5492-.1602-1.6401-1.0439C14.0668 18.3185 14 17.037 14 15.7378c0-1.299.0666-2.5799.196-3.8384.0908-.8837.9122-1.4083 1.64-1.0442.9851.4928 1.9559 1.0576 2.9072 1.6966.9838.6609 1.9195 1.3823 2.8052 2.1573.6021.5269.6021 1.5307 0 2.0577-.8857.775-1.8214 1.4964-2.8052 2.1573-.9511.6388-1.9219 1.2041-2.9068 1.6971Z"></path>
              ...
              <div>
                <div className="flex items-center gap-1">
                  ...
                  <svg
                    width="23"
                    height="24"
                    className="h-[14px] w-[14px] fill-titan-blue"
                    viewBox="0 0 23 24">
                    <path
                      fill=""
                      fill-rule="evenodd"
                      d="M21.2 16a5.7 5.7 0 0 0 0-7.9A28.3 28.3 0 0 0 7.5.1 5.3 5.3 0 0 0 1.3 4 29 29 0 0 0 1 20.3a5.4 5.4 0 0 0 6.4 3.5A27 27 0 0 0 21.1 16Zm-6.5-6.3a1 1 0 0 0-1.4-1.4L8.5 13l-1.8-1.8a1 1 0 0 0-1.4 1.4l2.5 2.5c.4.4 1 .4 1.4 0l5.5-5.5Z"></path>
                  </svg>
                </div>
